...
public class DocNavPanel extends JPanel
	 ...
	 *
	 */
	private class BrowseFileBtnListener implements ActionListener {
		
		public BrowseFileBtnListener( DocumentController controller ) {
			m_controller = controller;
		}
		
		@Override
		public void actionPerformed(ActionEvent arg0) {
			m_controller.OnChooseFile();
		}
	 ...
	 *
	 */
	private class FileSearchBtnListener implements ActionListener {
		
		public FileSearchBtnListener( DocumentController controller ) {
			m_controller = controller;
		}
		
		@Override
		public void actionPerformed(ActionEvent arg0) {
			m_controller.OnFileSearch();
		}
	...
	public void OnNewDocument()
	{
		...
		m_btnFileSearch.setEnabled(true);
	...
	public void OnDocumentClosing() {
		...
		m_btnFileSearch.setEnabled(false);
...
//		m_View.SetSelectedLine(lineNo);
	...
	protected void Init() {
		...
		m_btnFileSearch = new JButton("Find");
		m_btnFileSearch.setEnabled(false);
		m_btnFileSearch.addActionListener( new FileSearchBtnListener(m_controller) );

		m_btnBrowseFile = new JButton("...");
		m_btnBrowseFile.addActionListener( new BrowseFileBtnListener(m_controller) );

		m_PathPanel = new JPanel();
		m_PathPanel.setLayout( new BorderLayout() );
		m_PathPanel.add(m_btnFileSearch, BorderLayout.LINE_START);
	...
	private JButton							m_btnFileSearch;
